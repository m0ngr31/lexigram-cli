...
export const getSlots = (skill, config) => __awaiter(this, void 0, void 0, function* () {
    const types = [];
    const slots = yield getSlotData(config);
...
const getSlotData = (config) => __awaiter(this, void 0, void 0, function* () {
    ...
    let movieGenresArr = [];
    let musicvideosArr = [];
    let musicvideoGenresArr = [];
    let musiciansArr = [];
    let albumsArr = [];
    let songsArr = [];
    let musicGenresArr = [];
    let musicPlaylistsArr = [];
    let videoPlaylistsArr = [];
    let addonsArr = [];
    const optionsObj = {
        method: 'post',
        url,
    ...
    const promisesArr = [
        axios(Object.assign({}, optionsObj, { data: getTVShows })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getTVShowGenres })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getMovies })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getMovieGenres })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getMusicVideos })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getMusicVideoGenres })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getMusicians })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getAlbums })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getSongs })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getMusicGenres })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getMusicPlaylists })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getVideoPlaylists })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getAddonsVideo })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getAddonsAudio })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getAddonsImage })).catch(err => { throw new Error('Error talking to Kodi.'); }),
        axios(Object.assign({}, optionsObj, { data: getAddonsExe })).catch(err => { throw new Error('Error talking to Kodi.'); })
    ];
    try {
        const [shows, showgenres, movies, moviegenres, musicvideos, musicvideogenres, musicians, albums, songs, musicgenres, musicplaylists, videoplaylists, addonsvideo, addonsaudio, addonsimage, addonsexe] = yield axios.all(promisesArr);
